        ...
        <Container>
            <div className="About" id="about">
                ...
                <p>
                    ...
                    After that, I studied at the <a href="https://in.bgu.ac.il/Pages/default.aspx" target="_blank" className="text-decoration-none links">BGU</a> preparatory for Engineering and started learning Software Engineering at <a href="https://www.sce.ac.il/" target="_blank" className="text-decoration-none links">SCE</a>. <br />
